    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                ...
                <a href="${pageContext.request.contextPath}/admin?page=reports" class="flex flex-col items-center gap-2 p-4 rounded-xl border border-gray-100 hover:border-purple-200 hover:bg-purple-50 transition text-center">
